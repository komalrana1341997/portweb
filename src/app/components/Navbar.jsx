    ...
    <nav className="fixed top-0 w-full z-50 backdrop-blur-lg bg-black/40 border-b border-white/10">
      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="hidden md:flex gap-8 text-sm text-gray-300">
          ...
          <a href="#skills" className="hover:text-white font-semibold transition">Skills</a>
          <a href="#projects" className="hover:text-white font-semibold transition">Projects</a>
